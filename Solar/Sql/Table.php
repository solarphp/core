...
class Solar_Sql_Table extends Solar_Base {
	...
	*/
	...
	public function default($spec = null)
	{
	...
	* 
	* Composite: $this->primary('col_1', 'col_2', 'col_3');
	* 
	* @access protected
	* 
	* @return void
	* 
	...
	protected function colPrimary($name)
	{
		/** @todo Throw error if column doesn't exist @/
		$args = func_get_args();
	...
	* 
	...
	protected function idxNormal($name)
	{
		$cols = func_get_args();
	...
	* 
	...
	protected function idxUnique($name)
	{
		$cols = func_get_args();
		$name = array_shift($cols);
