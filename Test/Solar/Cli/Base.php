 ...
 * 
 */
class Test_Solar_Cli_Base extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Cli_Base = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Cli_Base');
        $this->assertInstance($obj, 'Solar_Cli_Base');
    }
