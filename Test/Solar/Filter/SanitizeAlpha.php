 ...
 * 
 */
class Test_Solar_Filter_SanitizeAlpha extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_SanitizeAlpha');
        $this->assertInstance($obj, 'Solar_Filter_SanitizeAlpha');
    }
