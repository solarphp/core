 ...
 * 
 */
class Test_Solar_Filter_SanitizeNumeric extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_SanitizeNumeric');
        $this->assertInstance($obj, 'Solar_Filter_SanitizeNumeric');
    }
