 ...
 * 
 */
class Test_Solar_Filter_ValidateInList extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateInList');
        $this->assertInstance($obj, 'Solar_Filter_ValidateInList');
    }
