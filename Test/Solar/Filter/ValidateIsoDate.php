 ...
 * 
 */
class Test_Solar_Filter_ValidateIsoDate extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateIsoDate');
        $this->assertInstance($obj, 'Solar_Filter_ValidateIsoDate');
    }
