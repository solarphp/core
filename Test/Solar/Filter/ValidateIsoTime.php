 ...
 * 
 */
class Test_Solar_Filter_ValidateIsoTime extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateIsoTime');
        $this->assertInstance($obj, 'Solar_Filter_ValidateIsoTime');
    }
