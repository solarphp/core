 ...
 * 
 */
class Test_Solar_Filter_ValidateNotInList extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateNotInList');
        $this->assertInstance($obj, 'Solar_Filter_ValidateNotInList');
    }
