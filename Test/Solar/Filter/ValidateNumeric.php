 ...
 * 
 */
class Test_Solar_Filter_ValidateNumeric extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateNumeric');
        $this->assertInstance($obj, 'Solar_Filter_ValidateNumeric');
    }
