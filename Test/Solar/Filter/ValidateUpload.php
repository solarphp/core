 ...
 * 
 */
class Test_Solar_Filter_ValidateUpload extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateUpload');
        $this->assertInstance($obj, 'Solar_Filter_ValidateUpload');
    }
