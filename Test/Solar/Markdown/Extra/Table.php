 ...
 * 
 */
class Test_Solar_Markdown_Extra_Table extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Extra_Table');
        $this->assertInstance($obj, 'Solar_Markdown_Extra_Table');
    }
