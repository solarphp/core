 ...
 * 
 */
class Test_Solar_Markdown_Plugin_BlockQuote extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_BlockQuote');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_BlockQuote');
    }
