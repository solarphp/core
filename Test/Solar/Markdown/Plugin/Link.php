 ...
 * 
 */
class Test_Solar_Markdown_Plugin_Link extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_Link');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_Link');
    }
    
    /**
     * 
     * Test -- Support callback for inline links.
     * 
     */
    public function test_parseInline()
    {
        $this->todo('stub');
    }
