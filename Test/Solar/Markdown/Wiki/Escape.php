 ...
 * 
 */
class Test_Solar_Markdown_Wiki_Escape extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Wiki_Escape');
        $this->assertInstance($obj, 'Solar_Markdown_Wiki_Escape');
    }
