 ...
 * 
 */
class Test_Solar_Markdown_Wiki_MethodSynopsis extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Wiki_MethodSynopsis');
        $this->assertInstance($obj, 'Solar_Markdown_Wiki_MethodSynopsis');
    }
