 ...
 * 
 */
class Test_Solar_Model_Areas_Collection extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Areas_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Areas_Collection');
        $this->assertInstance($obj, 'Solar_Model_Areas_Collection');
    }
