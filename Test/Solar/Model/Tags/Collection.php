 ...
 * 
 */
class Test_Solar_Model_Tags_Collection extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Tags_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Tags_Collection');
        $this->assertInstance($obj, 'Solar_Model_Tags_Collection');
    }
    ...
    /**
     * 
     * Test -- Gets the names of all tags in this collection as an array.
     * 
     */
