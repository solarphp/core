...
class Test_Solar_Smtp_Adapter_CramMd5Auth extends Test_Solar_Smtp_Adapter {
    ...
    {
        $obj = Solar::factory('Solar_Smtp_Adapter_CramMd5Auth');
        $this->assertInstance($obj, 'Solar_Smtp_Adapter_CramMd5Auth');
    }
    
    /**
     * 
     * Test -- Performs AUTH CRAM-MD5 with username, password, and server challenge.
     * 
     */
