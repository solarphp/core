 ...
 * 
 */
class Test_Solar_Sql_Adapter_MysqlReplicated extends Test_Solar_Sql_Adapter {
    ...
    {
        $obj = Solar::factory('Solar_Sql_Adapter_MysqlReplicated');
        $this->assertInstance($obj, 'Solar_Sql_Adapter_MysqlReplicated');
    }
    ...
    /**
     * 
     * Test -- Leave autocommit mode and begin a transaction **on the master**.
     * 
     */
    ...
    /**
     * 
     * Test -- Commit a transaction and return to autocommit mode **on the master**.
     * 
     */
    ...
    /**
     * 
     * Test -- Connects to a random slave server.
     * 
     */
    ...
    /**
     * 
     * Test -- Connects to the master server.
     * 
     */
    ...
    /**
     * 
     * Test -- Disconnects from the master and the slave.
     * 
     */
    ...
    /**
     * 
     * Test -- Get the master PDO connection object (connects to the database if  needed).
     * 
     */
    public function testGetPdoMaster()
    {
        $this->todo('stub');
    }
    ...
    /**
     * 
     * Test -- Roll back a transaction and return to autocommit mode **on the master**.
     * 
     */
