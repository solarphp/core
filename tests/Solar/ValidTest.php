...
require_once 'Solar/Valid.php';

/**
 * @todo Refactor all tests so they instantiate Solar_Valid themselves
 */
class Solar_ValidTest extends PHPUnit_Framework_TestCase
{
    private $_valid = null;
    ...
    {
        $object = Solar::factory('Solar_Valid');
        $this->assertTrue($object instanceof Solar_Valid);
    }
