 ...
 * 
 */
class Test_Solar_App_HelloAjax extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_App_HelloAjax = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_App_HelloAjax');
        $this->assertInstance($obj, 'Solar_App_HelloAjax');
    }
