 ...
 * 
 */
class Test_Solar_Example_Model_Users_Record extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_Users_Record = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_Users_Record');
        $this->assertInstance($obj, 'Solar_Example_Model_Users_Record');
    }
