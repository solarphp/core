 ...
 * 
 */
class Test_Solar_Http_Request_Adapter extends Solar_Test {
    ...
    /**
     * 
     * Test -- Fetches from the specified URI and returns a Solar_Http_Response object (or an array of objects if there was more than one response).
     * 
     */
