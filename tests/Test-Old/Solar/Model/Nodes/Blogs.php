 ...
 * 
 */
class Test_Solar_Model_Nodes_Blogs extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Blogs = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Blogs');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Blogs');
    }
