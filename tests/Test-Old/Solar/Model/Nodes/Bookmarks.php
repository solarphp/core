 ...
 * 
 */
class Test_Solar_Model_Nodes_Bookmarks extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Bookmarks = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Bookmarks');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Bookmarks');
    }
