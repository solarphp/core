 ...
 * 
 */
class Test_Solar_Model_Nodes_Comments extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Comments = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Comments');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Comments');
    }
