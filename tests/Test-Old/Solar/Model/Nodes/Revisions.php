 ...
 * 
 */
class Test_Solar_Model_Nodes_Revisions extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Revisions = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Revisions');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Revisions');
    }
