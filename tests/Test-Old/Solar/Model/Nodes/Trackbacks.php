 ...
 * 
 */
class Test_Solar_Model_Nodes_Trackbacks extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Trackbacks = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Trackbacks');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Trackbacks');
    }
     ...
     * 
     */
    public function testCountPagesByTags()
    {
        $this->todo('stub');
    }
     ...
     * 
     */
    public function testFetchAllByTags()
    {
        $this->todo('stub');
    }
