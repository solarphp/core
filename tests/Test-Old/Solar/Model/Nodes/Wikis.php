 ...
 * 
 */
class Test_Solar_Model_Nodes_Wikis extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Wikis = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Wikis');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Wikis');
    }
