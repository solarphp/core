 ...
 * 
 */
class Test_Solar_Sql_Model_Filter extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Sql_Model_Filter = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Sql_Model_Filter');
        $this->assertInstance($obj, 'Solar_Sql_Model_Filter');
    }
    ...
    /**
     * 
     * Test -- Applies the filter chain to a Record.
     * 
     */
    ...
    /**
     * 
     * Test -- Gets a **reference** to the data array, or a specific element of data, being processed by [[applyChain()]].
     * 
     */
