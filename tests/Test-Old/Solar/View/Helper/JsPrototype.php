 ...
 * 
 */
class Test_Solar_View_Helper_JsPrototype extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_View_Helper_JsPrototype = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_View_Helper_JsPrototype');
        $this->assertInstance($obj, 'Solar_View_Helper_JsPrototype');
    }
