 ...
 * 
 */
class Test_Solar_App_Base_Helper_Head extends Solar_Test_View_Helper {
     ...
     * 
     */
    protected $_Test_Solar_App_Base_Helper_Head = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_App_Base_Helper_Head');
        $this->assertInstance($obj, 'Solar_App_Base_Helper_Head');
    }
