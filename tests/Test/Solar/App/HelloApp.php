 ...
 * 
 */
class Test_Solar_App_HelloApp extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_App_HelloApp = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_App_HelloApp');
        $this->assertInstance($obj, 'Solar_App_HelloApp');
    }
