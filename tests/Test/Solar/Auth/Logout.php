 ...
 * 
 */
class Test_Solar_Auth_Logout extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Auth_Logout = array(
    );
    ...
    public function test__construct()
    {
        ...
        $actual = new Solar_Auth_Logout($this->_config);
        $expect = 'Solar_Auth_Logout';
    ...
    {
        $actual = Solar::factory('Solar_Auth_Logout');
        $expect = 'Solar_Auth_Logout_Adapter';
        $this->assertInstance($actual, $expect);
    }
}
