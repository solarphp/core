 ...
 * 
 */
class Test_Solar_Auth_Storage extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Auth_Storage = array(
    );
    ...
    public function test__construct()
    {
        ...
        $actual = new Solar_Auth_Storage($this->_config);
        $expect = 'Solar_Auth_Storage';
    ...
    final public function test__call()
    {
        // we use `new` instead of Solar::factory() so that we get back the
        // factory class itself, not an adapter generated by the factory
        $obj = new Solar_Auth_Storage($this->_config);
        try {
            $obj->noSuchMethod();
    ...
    {
        $actual = Solar::factory('Solar_Auth_Storage');
        $expect = 'Solar_Auth_Storage_Adapter';
        $this->assertInstance($actual, $expect);
    }
}
