 ...
 * 
 */
class Test_Solar_Example_Model_TestSolarFoo extends Test_Solar_Example_Model {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_TestSolarFoo = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_TestSolarFoo');
        $this->assertInstance($obj, 'Solar_Example_Model_TestSolarFoo');
    }
