 ...
 * 
 */
class Test_Solar_Example_Model_TestSolarFoo_Collection extends Test_Solar_Example_Model {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_TestSolarFoo_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_TestSolarFoo_Collection');
        $this->assertInstance($obj, 'Solar_Example_Model_TestSolarFoo_Collection');
    }
