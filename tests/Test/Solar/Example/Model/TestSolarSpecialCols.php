 ...
 * 
 */
class Test_Solar_Example_Model_TestSolarSpecialCols extends Test_Solar_Example_Model {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_TestSolarSpecialCols = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_TestSolarSpecialCols');
