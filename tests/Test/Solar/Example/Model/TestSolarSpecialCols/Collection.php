 ...
 * 
 */
class Test_Solar_Example_Model_TestSolarSpecialCols_Collection extends Test_Solar_Example_Model {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_TestSolarSpecialCols_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_TestSolarSpecialCols_Collection');
        $this->assertInstance($obj, 'Solar_Example_Model_TestSolarSpecialCols_Collection');
    }
