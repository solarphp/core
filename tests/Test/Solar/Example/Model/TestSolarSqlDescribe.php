 ...
 * 
 */
class Test_Solar_Example_Model_TestSolarSqlDescribe extends Test_Solar_Example_Model {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_TestSolarSqlDescribe = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_TestSolarSqlDescribe');
        $this->assertInstance($obj, 'Solar_Example_Model_TestSolarSqlDescribe');
    }
