 ...
 * 
 */
class Test_Solar_Example_Model_Users extends Test_Solar_Example_Model {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_Users = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_Users');
        $this->assertInstance($obj, 'Solar_Example_Model_Users');
    }
