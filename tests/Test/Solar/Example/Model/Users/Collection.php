 ...
 * 
 */
class Test_Solar_Example_Model_Users_Collection extends Test_Solar_Example_Model {
     ...
     * 
     */
    protected $_Test_Solar_Example_Model_Users_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Example_Model_Users_Collection');
        $this->assertInstance($obj, 'Solar_Example_Model_Users_Collection');
    }
