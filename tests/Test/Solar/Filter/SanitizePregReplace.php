 ...
 * 
 */
class Test_Solar_Filter_SanitizePregReplace extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_SanitizePregReplace');
        $this->assertInstance($obj, 'Solar_Filter_SanitizePregReplace');
    }
