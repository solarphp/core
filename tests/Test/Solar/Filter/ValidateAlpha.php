 ...
 * 
 */
class Test_Solar_Filter_ValidateAlpha extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateAlpha');
        $this->assertInstance($obj, 'Solar_Filter_ValidateAlpha');
    }
