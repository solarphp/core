 ...
 * 
 */
class Test_Solar_Filter_ValidateLocaleCode extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateLocaleCode');
        $this->assertInstance($obj, 'Solar_Filter_ValidateLocaleCode');
    }
