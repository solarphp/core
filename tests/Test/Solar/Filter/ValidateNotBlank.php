 ...
 * 
 */
class Test_Solar_Filter_ValidateNotBlank extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateNotBlank');
        $this->assertInstance($obj, 'Solar_Filter_ValidateNotBlank');
    }
