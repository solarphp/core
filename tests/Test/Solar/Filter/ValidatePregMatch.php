 ...
 * 
 */
class Test_Solar_Filter_ValidatePregMatch extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidatePregMatch');
        $this->assertInstance($obj, 'Solar_Filter_ValidatePregMatch');
    }
