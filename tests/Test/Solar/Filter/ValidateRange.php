 ...
 * 
 */
class Test_Solar_Filter_ValidateRange extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Filter_ValidateRange');
        $this->assertInstance($obj, 'Solar_Filter_ValidateRange');
    }
