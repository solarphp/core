...
class Test_Solar_Markdown_Extra extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Extra');
        $this->assertInstance($obj, 'Solar_Markdown_Extra');
    }
    ...
    /**
     * 
     * Test -- Returns an internal Markdow plugin object for direct manipulation and inspection.
     * 
     */
