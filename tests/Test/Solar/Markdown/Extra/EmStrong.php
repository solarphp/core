 ...
 * 
 */
class Test_Solar_Markdown_Extra_EmStrong extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Extra_EmStrong');
        $this->assertInstance($obj, 'Solar_Markdown_Extra_EmStrong');
    }
