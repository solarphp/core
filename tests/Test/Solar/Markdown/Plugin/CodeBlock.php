 ...
 * 
 */
class Test_Solar_Markdown_Plugin_CodeBlock extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_CodeBlock');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_CodeBlock');
    }
