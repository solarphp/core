 ...
 * 
 */
class Test_Solar_Markdown_Plugin_CodeSpan extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_CodeSpan');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_CodeSpan');
    }
