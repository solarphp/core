 ...
 * 
 */
class Test_Solar_Markdown_Plugin_Encode extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_Encode');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_Encode');
    }
