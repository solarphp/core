 ...
 * 
 */
class Test_Solar_Markdown_Plugin_Header extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_Header');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_Header');
    }
