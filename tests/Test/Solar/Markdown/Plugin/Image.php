...
class Test_Solar_Markdown_Plugin_Image extends Test_Solar_Markdown_Plugin {
    ...
    {
        $source = 'foo bar ![alt-text](/path/to/image_name.jpg) baz dib';
        $expect = 'foo bar <img src="/path/to/image_name.jpg" alt="alt-text" /> baz dib';
    ...
    {
        $source = 'foo bar ![alt-text](/path/to/image_name.jpg "with title") baz dib';
        $expect = 'foo bar <img src="/path/to/image_name.jpg" alt="alt-text" title="with title" /> baz dib';
        $actual = $this->_plugin->parse($source);
        $this->assertSame($actual, $expect);
    }
    ...
    {
        $this->_markdown->setLink('alt-text', '/path/to/image_name.jpg', 'with title');
    ...
    public function testParse_referenceDifferentAlt()
    {
        ...
        $expect = 'foo bar <img src="/path/to/image_name.jpg" alt="inline-text" title="with title" /> baz dib';
        $actual = $this->_plugin->parse($source);
        $this->assertSame($actual, $expect);
    }
}
