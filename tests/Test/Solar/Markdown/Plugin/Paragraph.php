 ...
 * 
 */
class Test_Solar_Markdown_Plugin_Paragraph extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_Paragraph');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_Paragraph');
    }
