 ...
 * 
 */
class Test_Solar_Markdown_Plugin_Prefilter extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Plugin_Prefilter');
        $this->assertInstance($obj, 'Solar_Markdown_Plugin_Prefilter');
    }
