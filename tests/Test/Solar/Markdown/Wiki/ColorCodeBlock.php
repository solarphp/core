 ...
 * 
 */
class Test_Solar_Markdown_Wiki_ColorCodeBlock extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Wiki_ColorCodeBlock');
        $this->assertInstance($obj, 'Solar_Markdown_Wiki_ColorCodeBlock');
    }
