 ...
 * 
 */
class Test_Solar_Markdown_Wiki_Header extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Markdown_Wiki_Header');
        $this->assertInstance($obj, 'Solar_Markdown_Wiki_Header');
    }
