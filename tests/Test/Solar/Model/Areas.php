 ...
 * 
 */
class Test_Solar_Model_Areas extends Test_Solar_Model {
     ...
     * 
     */
    protected $_Test_Solar_Model_Areas = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Areas');
        $this->assertInstance($obj, 'Solar_Model_Areas');
    }
