 ...
 * 
 */
class Test_Solar_Model_Bookmarks extends Test_Solar_Model {
     ...
     * 
     */
    protected $_Test_Solar_Model_Bookmarks = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Bookmarks');
        $this->assertInstance($obj, 'Solar_Model_Bookmarks');
    }
    ...
    /**
     * 
     * Test -- Fetches a collection of nodes with certain tags.
     * 
     */
