 ...
 * 
 */
class Test_Solar_Model_Nodes extends Test_Solar_Model {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes');
        $this->assertInstance($obj, 'Solar_Model_Nodes');
    }
