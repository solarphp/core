 ...
 * 
 */
class Test_Solar_Model_Nodes_Bookmarks_Record extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Bookmarks_Record = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Bookmarks_Record');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Bookmarks_Record');
    }
     ...
     * 
     */
    public function test__getTagsAsString()
    {
        $this->todo('stub');
    }
     ...
     * 
     */
    public function test__setTagsAsString()
    {
        $this->todo('stub');
    }
