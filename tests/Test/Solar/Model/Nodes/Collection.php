 ...
 * 
 */
class Test_Solar_Model_Nodes_Collection extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Nodes_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Nodes_Collection');
        $this->assertInstance($obj, 'Solar_Model_Nodes_Collection');
    }
