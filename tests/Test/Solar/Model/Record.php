 ...
 * 
 */
class Test_Solar_Model_Record extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_Model_Record = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Record');
        $this->assertInstance($obj, 'Solar_Model_Record');
    }
