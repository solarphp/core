 ...
 * 
 */
class Test_Solar_Model_Taggings extends Test_Solar_Model {
     ...
     * 
     */
    protected $_Test_Solar_Model_Taggings = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Taggings');
        $this->assertInstance($obj, 'Solar_Model_Taggings');
    }
