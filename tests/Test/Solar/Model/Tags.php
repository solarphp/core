 ...
 * 
 */
class Test_Solar_Model_Tags extends Test_Solar_Model {
     ...
     * 
     */
    protected $_Test_Solar_Model_Tags = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Model_Tags');
        $this->assertInstance($obj, 'Solar_Model_Tags');
    }
    ...
    /**
     * 
     * Test -- Fetches a collection of all tags applied by a particular owner (as identified by that user's "handle") with the count of nodes using each tag.
     * 
     */
    public function testFetchAllByOwnerHandle()
    {
        $this->todo('stub');
    }
    ...
    /**
     * 
     * Test -- Fetches a collection of all tags, with an added "count" column saying how many nodes use that tag.
     * 
     */
    public function testFetchAllWithCount()
    {
        $this->todo('stub');
    }
