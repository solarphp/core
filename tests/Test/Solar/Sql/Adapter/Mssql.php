 ...
 * 
 */
class Test_Solar_Sql_Adapter_Mssql extends Test_Solar_Sql_Adapter {
     ...
     * 
     */
    protected $_Test_Solar_Sql_Adapter_Mssql = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_Sql_Adapter_Mssql');
        $this->assertInstance($obj, 'Solar_Sql_Adapter_Mssql');
    }
    ...
    /**
     * 
     * Test -- Returns an array describing the columns in a table.
     * 
     */
