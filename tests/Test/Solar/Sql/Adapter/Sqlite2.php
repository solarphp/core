 ...
 * 
 */
class Test_Solar_Sql_Adapter_Sqlite2 extends Test_Solar_Sql_Adapter {
    ...
    {
        $obj = Solar::factory('Solar_Sql_Adapter_Sqlite2');
        $this->assertInstance($obj, 'Solar_Sql_Adapter_Sqlite2');
    }
    ...
    /**
     * 
     * Test -- Safely quotes a value for an SQL statement; unlike the main adapter, the SQLite adapter **does not** quote numeric values.
     * 
     */
