 ...
 * 
 */
class Test_Solar_Sql_Model_Related_BelongsTo extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Sql_Model_Related_BelongsTo');
        $this->assertInstance($obj, 'Solar_Sql_Model_Related_BelongsTo');
    }
