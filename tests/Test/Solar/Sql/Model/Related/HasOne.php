 ...
 * 
 */
class Test_Solar_Sql_Model_Related_HasOne extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_Sql_Model_Related_HasOne');
        $this->assertInstance($obj, 'Solar_Sql_Model_Related_HasOne');
    }
