 ...
 * 
 */
class Test_Solar_View_Helper_FormDate extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_View_Helper_FormDate');
        $this->assertInstance($obj, 'Solar_View_Helper_FormDate');
    }
