 ...
 * 
 */
class Test_Solar_View_Helper_FormXhtml extends Solar_Test {
    ...
    {
        $obj = Solar::factory('Solar_View_Helper_FormXhtml');
        $this->assertInstance($obj, 'Solar_View_Helper_FormXhtml');
    }
