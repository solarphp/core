 ...
 * 
 */
class Test_Solar_View_Helper_JsLibrary extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Solar_View_Helper_JsLibrary = array(
    );
    ...
    {
        $obj = Solar::factory('Solar_View_Helper_JsLibrary');
        $this->assertInstance($obj, 'Solar_View_Helper_JsLibrary');
    }
